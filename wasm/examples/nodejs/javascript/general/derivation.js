...
(async () => {
    ...
    let receiveWalletXPub = xPrv.derivePath("m/44'/123456'/0'/0").toXPub();
    ...
    let changeWalletXPub = xPrv.derivePath("m/44'/123456'/0'/1").toXPub();
    ...
    let privateKey = xPrv.derivePath("m/44'/123456'/0'/0/1").toPrivateKey();
