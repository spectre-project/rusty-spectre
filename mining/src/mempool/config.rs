use spectre_consensus_core::{config::params::ForkedParam, constants::TX_VERSION};
...
impl Config {
    ...
    /// The arguments should be obtained from the current consensus [`spectre_consensus_core::config::params::Params`] instance.
