...
mod tests {
    ...
    fn test_basic_sign_and_verify_sign() {
        let pm = PersonalMessage("Hello Spectre!");
        let privkey: [u8; 32] = [
...
Ut omnis magnam et accusamus earum rem impedit provident eum commodi repellat qui dolores quis et voluptate labore et adipisci deleniti. Est nostrum explicabo aut quibusdam labore et molestiae voluptate. Qui omnis nostrum At libero deleniti et quod quia.");
    ...
    #[test]
    fn test_fail_verify() {
        let pm = PersonalMessage("Not Hello Spectre!");
        let pubkey = XOnlyPublicKey::from_slice(&[
            0xF9, 0x30, 0x8A, 0x01, 0x92, 0x58, 0xC3, 0x10, 0x49, 0x34, 0x4F, 0x85, 0xF8, 0x9D, 0x52, 0x29, 0xB5, 0x31, 0xC8, 0x45,
            0x83, 0x6F, 0x99, 0xB0, 0x86, 0x01, 0xF1, 0x13, 0xBC, 0xE0, 0x36, 0xF9,
        ])
    ...
    fn test_sign_and_verify_test_case_0() {
        ...
        let expected_sig: Vec<u8> = [
            0xAC, 0xCF, 0xEC, 0x14, 0x67, 0x3F, 0xF5, 0xC5, 0xE2, 0x96, 0x39, 0xFE, 0x30, 0xED, 0x6F, 0xE6, 0x3C, 0x9E, 0x2E, 0x83,
            0x3A, 0xCE, 0x5D, 0x9A, 0x1A, 0x91, 0x96, 0xBB, 0x1D, 0xF9, 0x53, 0x3C, 0xFA, 0x6C, 0x49, 0x9B, 0xD8, 0x7F, 0xF7, 0xDC,
            0x77, 0x68, 0x5A, 0x77, 0x8F, 0x16, 0x4A, 0x47, 0xE2, 0x8B, 0x75, 0xA8, 0x6D, 0xCB, 0xA1, 0xBE, 0x34, 0x52, 0xFB, 0x0B,
            0xE3, 0xCA, 0x2E, 0x37,
        ]
        .to_vec();
    ...
    fn test_sign_and_verify_test_case_1() {
        ...
        .unwrap();
        let expected_sig: Vec<u8> = [
            0xCB, 0x83, 0x3C, 0x87, 0xE7, 0xB1, 0x2C, 0xA0, 0x65, 0xB1, 0xE7, 0x31, 0xF8, 0xEA, 0x50, 0x63, 0x56, 0x8A, 0x89, 0x8E,
            0xB7, 0xC6, 0x5C, 0x03, 0x56, 0x91, 0x86, 0xAE, 0xFD, 0xF9, 0xC2, 0xA7, 0x3F, 0x24, 0xA7, 0x40, 0x4B, 0xEC, 0x12, 0x5A,
            0xD2, 0x87, 0x0A, 0x7E, 0xBD, 0xDB, 0xC0, 0x3A, 0x02, 0x2D, 0x7C, 0x25, 0xE2, 0xE3, 0x93, 0xC6, 0x55, 0xDD, 0xC4, 0x30,
            0x5E, 0x01, 0xFC, 0x97,
        ]
        .to_vec();
