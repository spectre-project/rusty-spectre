...
use spectre_txscript::script_builder as native;
...
impl Default for ScriptBuilder {
    fn default() -> Self {
        Self { script_builder: Rc::new(RefCell::new(spectre_txscript::script_builder::ScriptBuilder::new())) }
    }
}
...
impl ScriptBuilder {
    ...
    /// and any push of data greater than [`MAX_SCRIPT_ELEMENT_SIZE`](spectre_txscript::MAX_SCRIPT_ELEMENT_SIZE) will not modify
    ...
    /// exceed the maximum allowed script engine size [`MAX_SCRIPTS_SIZE`](spectre_txscript::MAX_SCRIPTS_SIZE).
