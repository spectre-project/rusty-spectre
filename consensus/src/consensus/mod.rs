...
impl Consensus {
    ...
    fn pruning_samples_database_upgrade(&self) {
        ...
        let mut processed = 0;
        spectre_core::info!("Upgrading database to include and populate the pruning samples store");
        ...
        spectre_core::info!("Done upgrading database (populated {} entries)", processed);
    }
