...
pub const UTXO_KEY_SIZE: usize = spectre_hashes::HASH_SIZE + std::mem::size_of::<TransactionIndexType>();
...
impl From<UtxoKey> for TransactionOutpoint {
    fn from(k: UtxoKey) -> Self {
        ...
        let index = TransactionIndexType::from_le_bytes(
            <[u8; std::mem::size_of::<TransactionIndexType>()]>::try_from(&k.0[spectre_hashes::HASH_SIZE..])
