pub mod consensus {
    ...
    /// Highest proof of work difficulty target a Spectre block can have for all networks.
    ...
    /// Represents the number of block confirmations required to achieve
    /// absolute transaction irreversibility even against a dedicated attacker
    /// with 51% of network hashpower and unlimited resources.
