...
impl NetworkType {
    ...
    pub fn default_borsh_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 19110,
            NetworkType::Testnet => 19210,
            NetworkType::Simnet => 19510,
            NetworkType::Devnet => 19610,
        }
    }

    pub fn default_json_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 20110,
            NetworkType::Testnet => 20210,
            NetworkType::Simnet => 20510,
            NetworkType::Devnet => 20610,
        }
    }
...
impl NetworkId {
    ...
    pub fn default_p2p_port(&self) -> u16 {
        ...
        match self.network_type {
            NetworkType::Mainnet => 18111,
            NetworkType::Testnet => match self.suffix {
                Some(10) => 18211,
                Some(11) => 18311,
                None | Some(_) => 18411,
            },
            NetworkType::Simnet => 18511,
            NetworkType::Devnet => 18611,
        }
    }
