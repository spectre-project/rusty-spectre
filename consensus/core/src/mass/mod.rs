...
pub struct UtxoCell {
    ...
    pub plurality: u64,
    /// The amount of SPR (in sompis) locked in this UTXO
    pub amount: u64,
}
    ...
    fn test_storage_mass_pluralities() {
        ...
        */
        let test_cases = vec![
            ...
            PluralityTestCase {
                name: "1:3; output index=1, plurality=2; spr units",
                inputs_tx1: &[1000 * SOMPI_PER_SPECTRE],
                outputs_tx1: &[200 * SOMPI_PER_SPECTRE, 200 * SOMPI_PER_SPECTRE, 200 * SOMPI_PER_SPECTRE],
                inputs_tx2: &[1000 * SOMPI_PER_SPECTRE],
                outputs_tx2: &[200 * SOMPI_PER_SPECTRE, 400 * SOMPI_PER_SPECTRE],
                plurality_index: Some(1),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                name: "1:2; output index=0, plurality=2; spr units",
                inputs_tx1: &[1000 * SOMPI_PER_SPECTRE],
                outputs_tx1: &[200 * SOMPI_PER_SPECTRE, 200 * SOMPI_PER_SPECTRE],
                inputs_tx2: &[1000 * SOMPI_PER_SPECTRE],
                outputs_tx2: &[400 * SOMPI_PER_SPECTRE],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                name: "2:2; output index=0, plurality=2; spr units",
                inputs_tx1: &[350 * SOMPI_PER_SPECTRE, 500 * SOMPI_PER_SPECTRE],
                outputs_tx1: &[200 * SOMPI_PER_SPECTRE, 200 * SOMPI_PER_SPECTRE],
                inputs_tx2: &[350 * SOMPI_PER_SPECTRE, 500 * SOMPI_PER_SPECTRE],
                outputs_tx2: &[400 * SOMPI_PER_SPECTRE],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
            ...
            PluralityTestCase {
                name: "4:6; output index=0, plurality=3; spr units",
                inputs_tx1: &[350 * SOMPI_PER_SPECTRE, 500 * SOMPI_PER_SPECTRE, 350 * SOMPI_PER_SPECTRE, 500 * SOMPI_PER_SPECTRE],
                outputs_tx1: &[
                    200 * SOMPI_PER_SPECTRE,
                    200 * SOMPI_PER_SPECTRE,
                    400 * SOMPI_PER_SPECTRE,
                    250 * SOMPI_PER_SPECTRE,
                    250 * SOMPI_PER_SPECTRE,
                    250 * SOMPI_PER_SPECTRE,
                ],
                inputs_tx2: &[350 * SOMPI_PER_SPECTRE, 500 * SOMPI_PER_SPECTRE, 350 * SOMPI_PER_SPECTRE, 500 * SOMPI_PER_SPECTRE],
                outputs_tx2: &[200 * SOMPI_PER_SPECTRE, 200 * SOMPI_PER_SPECTRE, 400 * SOMPI_PER_SPECTRE, 750 * SOMPI_PER_SPECTRE],
