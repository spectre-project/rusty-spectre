...
/// `calculate_difficulty` is based on set_difficulty function: <https://github.com/tmrlvi/spectre-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L375>
/// @category PoW
