extern crate spectre_consensus;
extern crate spectre_core;
extern crate spectre_hashes;

use std::sync::Arc;

use spectre_alloc::init_allocator_with_default_settings;
use spectre_core::{info, signals::Signals};
...
pub fn main() {
    #[cfg(feature = "heap")]
    let _profiler = dhat::Profiler::builder().file_name("spectred-heap.json").build();
