...
use spectre_core::spectred_env::version;
use spectre_notify::address::tracker::Tracker;
use spectre_utils::networking::ContextualNetAddress;
use spectre_wrpc_server::address::WrpcNetAddress;
...
impl Args {
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> spectre_consensus_core::utxo::utxo_collection::UtxoCollection {
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("spectred")
        .about(format!("{} (rusty-spectre) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 18110, testnet: 18210)."),
        )
        .arg(
            Arg::new("rpclisten-borsh")
                ...
                .help("Interface:port to listen for wRPC Borsh connections (default port: 19110, testnet: 19210)."),
        ...
        .arg(
            Arg::new("rpclisten-json")
                ...
                .value_parser(clap::value_parser!(WrpcNetAddress))
                .help("Interface:port to listen for wRPC JSON connections (default port: 20110, testnet: 20210)."),
        )
        ...
        .arg(
            Arg::new("listen")
                ...
                .require_equals(true)
                .value_parser(clap::value_parser!(ContextualNetAddress))
                .help("Add an interface:port to listen for connections (default all interfaces port: 18111, testnet: 18211)."),
        )
        .arg(
            Arg::new("outpeers")
                .long("outpeers")
